...
export default function AddUserModal({ setUsers }) {
    ...
    return (<form className="form-submission" onSubmit={(e) => {
                    e.preventDefault();
                    submitForm();
                        setFormData({
                        id: null,
                    ...
                    <span>Name*</span><input type="text" name="name" value={formData.name} placeholder="Name" minLength={3} onChange={e => handleChange(e, "name")} disabled={submissionStatus} />
                    <span>Email*</span><input type="email" name="email" value={formData.email} placeholder="Email" onChange={e => handleChange(e, "email")} disabled={submissionStatus} />

                    <span>Status*</span><input type="text" name="status" value={formData.status}placeholder="Status" maxLength={1} onChange={e => handleChange(e, "status")} disabled={submissionStatus} />
